...
model_df = model_df[["DateTime", "temp"]].rename(columns={"temp": "Reading"})
model_df["Variable"] = "Temperature (°C)"
model_df["Site"] = "Model"
model_df["Agency"] = "Model"

# Load field data
field_fp = "Data/data-warehouse/parquet/WQ/Temperature.parquet"
...
field_df["Variable"] = "Temperature (°C)"
...
combined_df = combined_df[combined_df["Variable"] == "Temperature (°C)"]
...
ax.set_title("Lake Temperature Time Series: Model vs Field Data")
ax.legend()
ax.grid(True)
